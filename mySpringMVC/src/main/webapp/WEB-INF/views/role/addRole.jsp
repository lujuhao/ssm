		...
		<form id="addRoleForm" class="form-horizontal" role="form">
			...
			<div class="form-group">
				...
				<div class="col-sm-5 input-group">
					...
					<input type="text" class="form-control" id="role" name="role" required maxlength="16" placeholder="请输入登录名称">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-5 input-group">
					...
					<textarea name="describe" class="form-control" required maxlength="50" placeholder="请输入角色描述" rows="3" cols="10"></textarea>
				</div>
			</div>
