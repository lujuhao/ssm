...
<script src="${ctxStatic}/views/index/js/dashBoard.js"></script>
...
<script src="${ctxStatic}/views/index/js/index1.js"></script>
...
<script src="${ctxStatic}/views/index/js/Chart.bundle.js"></script>
<script src="${ctxStatic}/views/index/js/utils.js"></script>
</head>
<body>
	<div id="page-wrapper">
		<div class="main-page">
								...
								<div class="single-bottom">
									<ul>
										<li><input type="checkbox" id="brand" value=""> <label
											for="brand"><span></span> Integer sollicitudin
												lacinia condimentum.</label></li>
										...
										<li><input type="checkbox" id="brand2" value="">
											<label for="brand2"><span></span> Donec aliquam dolor
												eu augue condimentum.</label></li>
